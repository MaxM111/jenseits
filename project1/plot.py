...
palette = {
    ...
    "Vertical Optimized": "#ff7fae",  # pink
...
# ---- Vertical Optimized vs Best Vertical Function (Vertical Functions (Hash)) ----

vertical_funcs = ["Vertical Optimized", "Vertical Functions (Hash Index)"]
d = df[df["representation"].isin(vertical_funcs)]

plot_queries_3(d, "tupleCount", "Queries vs Tuple Count")
plot_queries_3(d, "attributeCount", "Queries vs Attribute Count")
plot_queries_3(d, "sparsity", "Queries vs Sparsity")
